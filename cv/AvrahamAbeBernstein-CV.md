...
1. _FOSS_ AI [Ollama](https://ollama.com/): a local AI LLM model that supports 32-64 GB RAM using an _x64_ CPU in order to eliminate the exhorbitant cost of server based AI, and in order to protect my privacy. I am using local AI as an intelligent __assistant__ where I note that AI is making intelligent comments about my code or documents, and __not__ to automatically generate [slop](https://en.wikipedia.org/wiki/AI_slop). And I am studying Google's [Open Knowledge Format]( https://cloud.google.com/blog/products/data-analytics/how-the-open-knowledge-format-can-improve-data-sharing/) in order to improve how to more efficiently interact with AI software, also in conjunction with [Obsidian OKF](https://github.com/kennyg/obsidian-okf).
2. _FOSS_ [Neovim](https://neovim.io/): a programming editor upgrade to [Vim](https://en.wikipedia.org/wiki/Vim_(text_editor)).
3. _FOSS_ [Tree-Sitter](https://tree-sitter.github.io/tree-sitter/) [Abstract Syntax Tree (AST)](https://en.wikipedia.org/wiki/Abstract_syntax_tree): a fast multi-language dynamic AST parser plugin for programming editors such as _neovim_ (above). Also [Emacs]( https://www.gnu.org/software/emacs/) has excellent tree-sitter support.
