...
PREFIX=https://www.AvrahamBernstein.com/cv
ROOT=AvrahamAbeBernstein-CV
HTML=$ROOT.html
MD=$ROOT.md
PDF=$ROOT.pdf

expander.py --eval "is_pdf=False;html='${PREFIX}/${HTML}';pdf='${PREFIX}/${PDF}'" -f $MD > cv.html.md
...
expander.py --eval  "is_pdf=True;html='${PREFIX}/${HTML}';pdf='${PREFIX}/${PDF}'" -f $MD > cv.pdf.md
