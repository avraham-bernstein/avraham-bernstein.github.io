...
* __Articles & Blog:__ TBD
	...
	1. _Torah_ & _Yisrael_:
		...
		* The scientific evidence for divine creation, according to the [Ramban's (c. 1250 CE)](https://en.wikipedia.org/wiki/Nachmanides) commentary on the first two chapters of the book of [Genesis](https://en.wikipedia.org/wiki/Book_of_Genesis), [Gerald Schroeder's book "Genesis and the Big Bang" ](https://en.wikipedia.org/wiki/Gerald_Schroeder), and [Nathan Aviezer's book "In the Beginning: Biblical Creation and Science"](https://en.wikipedia.org/wiki/Nathan_Aviezer).
